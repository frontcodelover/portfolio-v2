...
export const About = () => {
  ...
  return (
    <motion.div initial='hidden' whileInView='visible' viewport={{ once: true, amount: 0.5 }} variants={aboutVariants} className='flex flex-col md:text-xl text-lg text-slate-500 tracking-tight 4k:text-4xl'>
