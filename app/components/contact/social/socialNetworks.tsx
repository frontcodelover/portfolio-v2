  ...
  return (
    <div className='flex gap-4 items-center justify-center flex-wrap'>
      <Link href='https://www.linkedin.com/in/nicolas-de-raemy/' target='_blank'>
        <div className='flex gap-2 items-center  hover:text-slate-600  bg-white px-6 py-1 rounded-2xl text-xl text-slate-900 tracking-tighter dark:border-none border'>
          <FaLinkedin />
          <span>LinkedIn</span>
        </div>
      </Link>
